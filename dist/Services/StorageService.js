...
export class StorageService {
    ...
    async importNewFile(originalFilePath) {
        try {
            const fileId = uuidv4();
    ...
    async saveGeneratedPDF(sourcesFilePath, outputsFileName) {
        try {
    ...
    async getDiskSpaceUsage(directory) {
        let totalBytes = 0;
    ...
    get getStoragePath() { return this.baseDirectory; }
    get getSourcesPath() { return this.sourcesDirectory; }
    get getoutputsPath() { return this.outputsDirectory; }
    get getThumbnailsPath() { return this.thumbnailsDirectory; }
    //Allows me to use the database path when initializing the database service
    get getDatabasePath() { return path.join(this.baseDirectory, "app.db"); }
}
